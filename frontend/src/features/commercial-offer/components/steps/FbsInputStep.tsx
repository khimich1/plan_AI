    ...
    <Card
      ...
      subtitle={
        hasDraft
          ...
          : "Вставьте текст списка ФБС или загрузите фото таблицы."
      }
    >
      <div style={{ display: "grid", gap: "1rem" }} onPaste={handlePaste}>
        <FieldWrapper label="Список ФБС">
          <Textarea
            value={sourceText}
          ...
          >
            ...
            {onAiInstructionChange && onApplyAi && (
              <FieldWrapper
                ...
                hint="Редкий сценарий: опишите, что сделать со списком ФБС."
              >
                <Textarea
                  value={aiInstruction}
          ...
          {isBatchReviewMode && (
            <>
              ...
              {draft.metadata.ocr_verify_failed && (
                <Alert tone="warning">
                  Повторная проверка распознавания не удалась — сверьте список ФБС с исходным фото вручную.
                </Alert>
              )}
