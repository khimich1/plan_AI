    ...
    <Card
      ...
      subtitle={
        hasDraft
          ...
          : "Вставьте текст списка маршей или загрузите фото таблицы."
      }
    >
      <div style={{ display: "grid", gap: "1rem" }} onPaste={handlePaste}>
        <FieldWrapper label="Список маршей">
          <Textarea
            value={sourceText}
          ...
          >
            ...
            {onAiInstructionChange && onApplyAi && (
              <FieldWrapper
                ...
                hint="Редкий сценарий: опишите, что сделать со списком маршей."
              >
                <Textarea
                  value={aiInstruction}
          ...
          <div style={{ display: "flex", justifyContent: "space-between", gap: "0.75rem", flexWrap: "wrap", width: "100%" }}>
            ...
            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
              ...
              <Button
                ...
                onClick={onFinishMarches}
                disabled={!canFinishMarches}
