    ...
    <Card
      ...
      subtitle={
        hasDraft
          ...
          : "Вставьте текст списка ступеней или загрузите фото таблицы."
      }
    >
      <div style={{ display: "grid", gap: "1rem" }} onPaste={handlePaste}>
        <FieldWrapper label="Список ступеней">
          <Textarea
            value={sourceText}
          ...
          >
            ...
            {onAiInstructionChange && onApplyAi && (
              <FieldWrapper
                ...
                hint="Редкий сценарий: опишите, что сделать со списком ступеней."
              >
                <Textarea
                  value={aiInstruction}
                  onChange={(event) => onAiInstructionChange(event.target.value)}
                  placeholder="Например: убери строки с ЛС11"
                />
      ...
      description={
        isBatchReviewMode
          ...
          : hasDraft
            ...
            : "Загрузите фото или вставьте список ступеней для расчёта."
      }
      footer={
        hasDraft ? (
          ...
          {isBatchReviewMode && (
            <>
              ...
              >
                ...
                <Card title="Список ступеней для расчёта" subtitle="Сверьте позиции текущего источника с фото или текстом.">
                  {batchReviewDraft && (
                    <PlateListEditor
