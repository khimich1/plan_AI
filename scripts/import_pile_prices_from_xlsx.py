#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Импорт прайса цельных свай из Excel в pb.db (таблица pile_prices)."""
...
from core.pile_price_db import import_pile_prices_from_xlsx, parse_pile_price_rows_from_xlsx
from core.project_paths import PRICE_DB_PATH


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Загрузить прайс цельных свай из Excel в pb.db (INSERT OR REPLACE)."
    )
    ...
    preview = parse_pile_price_rows_from_xlsx(str(xlsx_path), preferred_sheet=args.sheet)
    if not preview:
