#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Импорт прайса ФБС из Excel в pb.db (таблица fbs_prices)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Загрузить прайс ФБС из Excel в pb.db (INSERT OR REPLACE)."
    )
    ...
    preview = parse_fbs_price_rows_from_xlsx(str(xlsx_path), preferred_sheet=args.sheet)
    if not preview:
