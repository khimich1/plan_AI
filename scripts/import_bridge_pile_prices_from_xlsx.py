#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Импорт прайса мостовых свай из Excel в pb.db (таблица bridge_pile_prices)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Загрузить прайс мостовых свай из Excel в pb.db (INSERT OR REPLACE)."
    )
    ...
    preview = parse_bridge_pile_price_rows_from_xlsx(str(xlsx_path), preferred_sheet=args.sheet)
    if not preview:
