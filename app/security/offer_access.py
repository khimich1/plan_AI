...
Менеджеры и администраторы разделяют полный доступ на чтение и изменение
всех КП во всех разделах — это осознанная бизнес-политика, а не IDOR.
Поле owner_user_id в модели данных зарезервировано для будущей политики
и в текущих проверках не используется.

Политика доступа задокументирована: ai_docs/develop/architecture/offer-access-policy.md
"""
