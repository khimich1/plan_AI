...
class KpArchiveRepository:
    ...
    def update_logistics_cost(self, kp_id: int, logistics_cost: float, *, pile_logistics_cost: float | None = None, pile_trip_overrides: dict | None = None, long_pile_delivery: dict | None = None) -> bool:
