"""BP-503: bridge pile KPs excluded from production wizard candidates."""
...
def test_list_kps_in_production_excludes_bridge_piles(db_path: str) -> None:
